<?php
    include '../Modelos/evaluacionModelo.php';
?>
...
<head>
    ...
    <script tipe="text/javascript" src="./Controladores/evaluacionControlador.js"></script>
</head>
        ...
        <form id="frmEvaluacion">
            <div class="form-group">
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <input type="email" class="form-control form-control-sm col-sm-4" 
                ...
                <button id="Siguiente" type="button" class="btn btn-secondary" onclick="Next();">Siguiente</button>
                <button id="Enviar" type="button" class="btn btn-primary" disabled>Enviar</button>
            </div>
        </form>
    </div>
